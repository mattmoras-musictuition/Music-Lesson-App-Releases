...
const ACTION_TOOLS = [
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        reason:        { type: "string", enum: ["student_absent","informed_absence","uninformed_absence","teacher_absent","extended_absence","cancelled","other"], description: "Reason for the missed lesson" },
        reasonDetail:  { type: "string", description: "Optional free-text detail about the reason" },
        makeupEligible:{ type: "boolean", description: "Whether a catch-up lesson is owed. Default true for student_absent/informed_absence/uninformed_absence, false for extended_absence and cancelled." },
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        reason:        { type: "string", enum: ["student_absent","informed_absence","uninformed_absence","teacher_absent","extended_absence","cancelled","other"] },
...
export default function MusicTimetableApp() {
  ...
  const _isAutoUntouched = (e) => {
    ...
    // "removed", "informed_absence", "extended_absence" etc. are user-set.
