...
export function BandsManager({ bands, setBands, schools, students, teachers, resources = [], tallyEntries, setTallyEntries, notify, goBack, goForward, historyCursor, pageHistory, hideTitle = false, triggerNew = 0, onCompose }) {
