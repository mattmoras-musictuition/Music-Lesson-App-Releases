...
// plus a simple link card for link-type resources. PDF rendering
// lazy-loads pdfjs-dist's legacy build (transpiled for the app's
// Electron 29 / Chromium 122), self-hosting the matching worker
// from public/.
// ============================================================
...
export async function renderPdfFirstPage(url) {
